...
namespace rosneuro {
    ...
    TEST_F(HammingTestSuite, Integration){
        std::string base_path = ros::package::getPath("rosneuro_filters_hamming");
        ...
        DynamicMatrix<double> output = hamming_filter->apply(input);
